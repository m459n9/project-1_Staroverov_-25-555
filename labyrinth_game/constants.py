ROOMS = {
    ...
    "hall": {
        ...
        "items": [],
        "puzzle": (
            'На пьедестале надпись: "Назовите число, которое идет после '
    ...
    "trap_room": {
        ...
        "items": ["rusty_key"],
        "puzzle": (
            'Система плит активна. Чтобы пройти, назовите слово "шаг" три '
            'раза подряд (введите "шаг шаг шаг")',
            "шаг шаг шаг",
        ),
    },
    "library": {
        ...
        "exits": {"east": "hall", "north": "armory", "west": "tower"},
        "items": ["ancient_book"],
        "puzzle": (
    ...
    "armory": {
        ...
        "exits": {"south": "library", "west": "cellar"},
    ...
    "garden": {
        "description": (
            "Подземный сад. Свет пробивается сквозь трещины в потолке, "
            "всё заросло мхом."
        ),
        "exits": {"west": "hall"},
        "items": ["strange_flower"],
        "puzzle": (
    ...
    "tower": {
        ...
        "exits": {"east": "library"},
        "items": ["crystal"],
        "puzzle": ("На стене уравнение: 2 + 2 * 2 = ?", "6"),
    },
    "cellar": {
        "description": (
            "Сырой подвал с деревянными бочками. В воздухе пахнет плесенью."
        ),
        "exits": {"east": "armory"},
        "items": ["old_coin"],
        "puzzle": ('На бочке надпись: "Сколько будет 3+7?"', "10"),
    },
}
...
COMMANDS = {
    ...
    "take <item>": "поднять предмет (используйте snake_case)",
    "use <item>": "использовать предмет",
    "inventory": "показать инвентарь",
    "solve": "решить загадку / открыть сундук (в treasure_room)",
